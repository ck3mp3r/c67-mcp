...
async fn test_client_initialization() {
    ...
    let _client1 = Context7Client::new_with_base_url(None, "https://context7.com/api".to_string(), false);
...
async fn test_client_initialization_with_insecure_flag() {
    ...
    let _client_secure = Context7Client::new_with_base_url(None, "https://context7.com/api".to_string(), false);

    // Test client can be created with insecure flag
    let _client_insecure = Context7Client::new_with_base_url(None, "https://context7.com/api".to_string(), true);
